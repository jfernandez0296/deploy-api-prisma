...
CREATE TABLE `task` (
    ...
    INDEX `fk_task_task-state1_idx`(`idtask-state`),
...
-- AddForeignKey
ALTER TABLE `task` ADD CONSTRAINT `fk_task_task-state1` FOREIGN KEY (`idtask-state`) REFERENCES `task-state`(`idtask-state`) ON DELETE NO ACTION ON UPDATE NO ACTION;
